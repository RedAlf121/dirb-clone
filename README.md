...
1. Tomar una URL base (por ejemplo, https://example.com)
2. Probar múltiples rutas posibles (como /admin, /login, /config) usando un diccionario de palabras
3. Enviar solicitudes HTTP a cada ruta generada
4. Detectar cuáles existen observando las respuestas del servidor
